...
GOOGLE_WORKSPACE_GUIDANCE = (
    ...
    "- `create_spreadsheet` takes ONLY `title` (and optional `sheet_names`).\n"
    "  It has NO `description` argument — inventing one fails validation and\n"
    "  trips the circuit-breaker. Pass just the title.\n"
